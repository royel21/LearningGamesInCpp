...
namespace internal
{
    ...
    struct TypeHelper<ValueType, typename ValueType::Object>
    {
        ...
        static ObjectType Get(ValueType &v) { return v.GetJsonObject(); }
    ...
    struct TypeHelper<ValueType, typename ValueType::ConstObject>
    {
        ...
        static bool Is(const ValueType &v) { return v.IsObject(); }
        static ObjectType Get(const ValueType &v) { return v.GetJsonObject(); }
    };
...
public:
    ...
    */
    ...
    /*!
        \param o An object obtained by \c GetJsonObject().
    ...
    */
    ...
    ConstObject GetJsonObject() const
    {
        RAPIDJSON_ASSERT(IsObject());
...
/*!
    Instance of this helper class is obtained by \c GenericValue::GetJsonObject().
    In addition to all APIs for array type, it provides range-based for loop if \c RAPIDJSON_HAS_CXX11_RANGE_FOR=1.
*/
template <bool Const, typename ValueT>
class GenericObject
